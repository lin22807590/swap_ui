...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.rwidget.view = QTableView()
        self.rwidget.view.horizontalHeader().hide()
        self.rwidget.view.verticalHeader().hide()
        self.rwidget.view.setGridStyle(Qt.NoPen)
        
        delegate = PreviewDelegate()
        self.rwidget.view.setItemDelegate(delegate)
        self.model = PreviewModel()
        self.rwidget.view.setModel(self.model)
        
        #self.setCentralWidget(self.rwidget.view)
        ...
        self.rwidget.view.resizeRowsToContents()
        self.rwidget.view.resizeColumnsToContents()
